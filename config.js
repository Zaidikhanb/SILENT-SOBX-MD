...
module.exports = {
    ...
    CAPTION: process.env.CAPTION || "POWERED BY *Zaid ★ ßadana +923299931199*",
    ...
    BOT_NAME: process.env.BOT_NAME || "➺Zaid ★ Badana +923299931199࿐",
    STATUS_REPLY: process.env.STATUS_REPLY || "`➺Zaid Badana Bot 💚 +923299931199 see your status`",
